...
let asyncRealpath = (() => {var _ref = _asyncToGenerator(function* (path) {
  ...
  {let config = _ref3.config;var _ref3$resetCache = _ref3.resetCache;let resetCache = _ref3$resetCache === undefined ? false : _ref3$resetCache;var _ref3$maxWorkers = _ref3.maxWorkers;let maxWorkers = _ref3$maxWorkers === undefined ? 1 : _ref3$maxWorkers;var _ref3$projectRoots = _ref3.projectRoots;let projectRoots = _ref3$projectRoots === undefined ? [] : _ref3$projectRoots;var _ref3$watch = _ref3.watch;let watch = _ref3$watch === undefined ? false : _ref3$watch;
...
exports.runServer = (() => {var _ref5 = _asyncToGenerator(function* (options) {
    ...
    yield exports.createConnectMiddleware({
      ...
      maxWorkers: options.maxWorkers,
      projectRoots: options.projectRoots,
      resetCache: options.resetCache });const middleware = _ref6.middleware,end = _ref6.end;
