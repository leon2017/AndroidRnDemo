    ...
    this._modifiedFiles = new Set();this._deletedFiles = new Set();this._dependencyEdges = new Map();} /**
      ...
      _this._currentBuildPromise = _this._getChangedDependencies(modifiedFiles, deletedFiles);let result;const numDependencies = _this._dependencyEdges.size;try {result = yield _this._currentBuildPromise;} catch (error) {// In case of error, we don't want to mark the modified files as
        ...
        if (_this._dependencyEdges.size !== numDependencies) {_this._dependencyEdges = new Map();}throw error;} finally {_this._currentBuildPromise = null;}return result;})();} /**
                                                                                                                                                                                  ...
                                                                                                                                                                                  */getTransformerOptions() {var _this2 = this;return _asyncToGenerator(function* () {if (!_this2._transformerOptions) {_this2._transformerOptions = yield _this2._calcTransformerOptions();}return _this2._transformerOptions;})();}_calcTransformerOptions() {var _this3 = this;return _asyncToGenerator(function* () {var _bundler$getGlobalTra = _this3._bundler.getGlobalTransformOptions();const enableBabelRCLookup = _bundler$getGlobalTra.enableBabelRCLookup,projectRoot = _bundler$getGlobalTra.projectRoot;const transformOptionsForBlacklist = { enableBabelRCLookup, dev: _this3._options.dev, generateSourceMaps: _this3._options.generateSourceMaps, hot: _this3._options.hot, inlineRequires: false, minify: _this3._options.minify, platform: _this3._options.platform, projectRoot };var _ref3 = yield _this3._bundler.getTransformOptionsForEntryFile(_this3._options.entryFile, { dev: _this3._options.dev, platform: _this3._options.platform }, (() => {var _ref4 = _asyncToGenerator(function* (path) {var _ref5 = yield initialTraverseDependencies(path, _this3._dependencyGraph, transformOptionsForBlacklist, new Map());const added = _ref5.added;return [path].concat(_toConsumableArray(added));});return function (_x) {return _ref4.apply(this, arguments);};})());const inlineRequires = _ref3.inlineRequires; // $FlowFixMe flow does not recognize well Object.assign() return types.
      ...
      deletedFiles.forEach(function (filePath) {
        const edge = _this4._dependencyEdges.get(filePath);
      ...
      _this4._options.onProgress || undefined);const added = _ref7.added,deleted = _ref7.deleted;


      const modified = new Map();

      for (const path of modifiedDependencies) {
        modified.set(path, _this4._dependencyGraph.getModuleForPath(path));
      }
