...
class OptionsHasher {
  ...
  {const
    ...
    options.enableBabelRCLookup,generateSourceMaps = options.generateSourceMaps,dev = options.dev,hot = options.hot,inlineRequires = options.inlineRequires,minify = options.minify,platform = options.platform,projectRoot = options.projectRoot,unknowns = _objectWithoutProperties(options, ['enableBabelRCLookup', 'generateSourceMaps', 'dev', 'hot', 'inlineRequires', 'minify', 'platform', 'projectRoot']);
