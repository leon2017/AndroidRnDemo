...
function processRequireCall(context, path, node, depMapIdent) {var _getModuleNameFromCal3 =
  getModuleNameFromCallArgs(
  'require',
  node,
  path),_getModuleNameFromCal4 = _slicedToArray(_getModuleNameFromCal3, 2);const nameExpression = _getModuleNameFromCal4[0],name = _getModuleNameFromCal4[1];
