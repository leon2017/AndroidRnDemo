...
class Server {
  ...
  getRamBundleInfo(options) {var _this2 = this;return _asyncToGenerator(function* () {
      options = _extends({}, options, { deltaBundleId: null });
  ...
  getAssets(options) {var _this3 = this;return _asyncToGenerator(function* () {
      return yield Serializers.getAssets(_this3._deltaBundler, _extends({},
      options, {
        deltaBundleId: null }));})();
  ...
  {var _this6 = this;return _asyncToGenerator(function* () {
      ...
      if (pathname.match(/\.bundle$/)) {
        yield _this6._processBundleRequest(req, res);
      } else if (pathname.match(/\.map$/)) {
        yield _this6._processSourceMapRequest(req, res);
      } else if (pathname.match(/\.assets$/)) {
        yield _this6._processAssetsRequest(req, res);
      } else if (pathname.match(/\.delta$/)) {
        yield _this6._processDeltaRequest(req, res);
      } else if (pathname.match(/^\/onchange\/?$/)) {
        _this6._processOnChangeRequest(req, res);
      } else if (pathname.match(/^\/assets\//)) {
        yield _this6._processSingleAssetRequest(req, res);
      } else if (pathname === '/symbolicate') {
        _this6._symbolicate(req, res);
      } else if (next) {
        next();
      } else {
        res.writeHead(404);
  ...
  _processDeltaRequest(req, res) {var _this7 = this;return _asyncToGenerator(function* () {
      const mres = MultipartResponse.wrap(req, res);var _prepareDeltaBundler =
      _this7._prepareDeltaBundler(req, mres);const options = _prepareDeltaBundler.options,buildID = _prepareDeltaBundler.buildID;
      ...
      try {
        output = yield Serializers.deltaBundle(_this7._deltaBundler, _extends({},
        options, {
  ...
  _processBundleRequest(req, res) {var _this8 = this;return _asyncToGenerator(function* () {
      const mres = MultipartResponse.wrap(req, res);var _prepareDeltaBundler2 =
      _this8._prepareDeltaBundler(req, mres);const options = _prepareDeltaBundler2.options,buildID = _prepareDeltaBundler2.buildID;
      ...
      try {
        result = yield Serializers.fullBundle(_this8._deltaBundler, _extends({},
        options, {
          deltaBundleId: _this8._optionsHash(options) }));
  ...
  _processSourceMapRequest(req, res) {var _this9 = this;return _asyncToGenerator(function* () {
      const mres = MultipartResponse.wrap(req, res);var _prepareDeltaBundler3 =
      _this9._prepareDeltaBundler(req, mres);const options = _prepareDeltaBundler3.options,buildID = _prepareDeltaBundler3.buildID;
      ...
      try {
        sourceMap = yield Serializers.fullSourceMap(_this9._deltaBundler, _extends({},
        options, {
          deltaBundleId: _this9._optionsHash(options) }));
  ...
  _processAssetsRequest(req, res) {var _this10 = this;return _asyncToGenerator(function* () {
      const mres = MultipartResponse.wrap(req, res);var _prepareDeltaBundler4 =
      _this10._prepareDeltaBundler(req, mres);const options = _prepareDeltaBundler4.options,buildID = _prepareDeltaBundler4.buildID;
      ...
      try {
        assets = yield _this10.getAssets(options);
      } catch (error) {
  ...
  _sourceMapForURL(reqUrl) {var _this11 = this;return _asyncToGenerator(function* () {
      const options = _this11._getOptionsFromUrl(reqUrl);

      return yield Serializers.fullSourceMapObject(_this11._deltaBundler, _extends({},
      options, {
        deltaBundleId: _this11._optionsHash(options) }));})();
